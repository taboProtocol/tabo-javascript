const TaboBalance = require("./TaboBalance");
...
class MoneroSubaddress {
  constructor(stateOrAddress, accountIndex, index) {
    if (stateOrAddress === undefined || typeof stateOrAddress === "string") {
      ...
      if (this.state.balance !== undefined && !(this.state.balance instanceof TaboBalance))
        this.state.balance = new TaboBalance(this.state.balance);
      if (this.state.unlockedBalance !== undefined && !(this.state.unlockedBalance instanceof TaboBalance))
        this.state.unlockedBalance = new TaboBalance(this.state.unlockedBalance);
    }
  }
