...
void monero_wasm_bridge::get_reserve_info(int handle, emscripten::val callback) {
  ...
  boost::multiprecision::uint128_t tabo_reserve = 0;
  ...
  wallet->get_reserve_info(tabo_reserve, num_stables, num_reserves, assets, assets_ma, liabilities, equity, equity_ma, reserve_ratio, reserve_ratio_ma);

  uint64_t reserve_ratio_int = reserve_ratio * 1000000000000;
  uint64_t reserve_ratio_ma_int = reserve_ratio_ma * 1000000000000;

  reserve_info_map["tabo_reserve"] = tabo_reserve.convert_to<std::string>();
