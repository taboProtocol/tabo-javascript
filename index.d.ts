...
export var TaboBalance: typeof import("./src/main/js/wallet/model/TaboBalance");
export var TaboReserveInfo: typeof import("./src/main/js/wallet/model/TaboReserveInfo");
